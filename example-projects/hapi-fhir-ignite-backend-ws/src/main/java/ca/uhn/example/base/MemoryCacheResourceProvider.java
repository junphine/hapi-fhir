 ...
 */
public class MemoryCacheResourceProvider<T extends IBaseResource> implements IResourceProvider {
	private static final Logger ourLog = LoggerFactory.getLogger(MemoryCacheResourceProvider.class);
	 ...
	 */
	public MemoryCacheResourceProvider(FhirContext theFhirContext, Class<T> theResourceType) {
	 ...
	 * @param theResourceType The resource type to support
	 */
	public MemoryCacheResourceProvider(FhirContext theFhirContext) {
		myFhirContext = theFhirContext;
